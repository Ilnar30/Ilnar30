### Всем привет 👋 Добро пожаловать в мой профиль ✌️
:dart: Изучаю процессы полного выстраивания автоматизации.Такие как: **разработке автотестов**, **выстраиванию инфраструктуры**, **визуализации результатов тестирования**, и **тест-менеджменту**. На курсе использовали следующие инструменты автоматизации:
<p align="center">

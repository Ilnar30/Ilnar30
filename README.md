...
:dart: Изучаю процессы полного выстраивания автоматизации. Проходил курс на **[QA.GURU school](https://qa.guru)**, где нас обучили **разработке автотестов**, **выстраиванию инфраструктуры**, **визуализации результатов тестирования**, и **тест-менеджменту**. На курсе использовали следующие инструменты автоматизации:
<p align="center">
